...
const navigationItems = [
  ...
  { key: 'nav.aiMatching', href: '/ai-matching', icon: SparklesIcon },
  { key: 'nav.predictions', href: '/predictions', icon: ChartBarIcon },
  { key: 'nav.dynamicPricing', href: '/dynamic-pricing', icon: BoltIcon },
  { key: 'nav.routeOptimizer', href: '/route-optimizer', icon: MapIcon },
  { key: 'nav.documentOcr', href: '/document-ocr', icon: DocumentTextIcon },
  ...
  { key: 'nav.blockchain', href: '/blockchain', icon: ShieldCheckIcon },
  { key: 'nav.invoices', href: '/invoices', icon: DocumentTextIcon },
  { key: 'nav.payments', href: '/payments', icon: CreditCardIcon },
  { key: 'nav.multimodal', href: '/multimodal', icon: GlobeAltIcon },
  ...
  { key: 'nav.enterprise', href: '/enterprise', icon: BuildingOffice2Icon },
